<?php
/**
 * Edit Course - Modify existing programming course
 */
    ...
    <div class="container">
        ...
        <div class="form-container">
            <div class="course-info">
                <h3>Editing Course #<?= $course['id']; ?></h3>
                <p>Originally created on <?= date('F j, Y', strtotime($course['created_at'])); ?></p>
            </div>

            <div class="form-header">
                <h2>Edit Course Details</h2>
                <p>Update the information for this programming course</p>
            </div>
            
            <form method="POST" action="edit_course.php?id=<?= $course_id; ?>" id="courseForm">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="programming_language" name="programming_language" required>
                            ...
                            <option value="Python" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'Python') ? 'selected' : ''; ?>>Python</option>
                            <option value="JavaScript" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'JavaScript') ? 'selected' : ''; ?>>JavaScript</option>
                            <option value="Java" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'Java') ? 'selected' : ''; ?>>Java</option>
                            <option value="PHP" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'PHP') ? 'selected' : ''; ?>>PHP</option>
                            <option value="C++" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'C++') ? 'selected' : ''; ?>>C++</option>
                            <option value="C#" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'C#') ? 'selected' : ''; ?>>C#</option>
                            <option value="Ruby" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'Ruby') ? 'selected' : ''; ?>>Ruby</option>
                            <option value="Go" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'Go') ? 'selected' : ''; ?>>Go</option>
                            <option value="Rust" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'Rust') ? 'selected' : ''; ?>>Rust</option>
                            <option value="Swift" <?= ((isset($_POST['programming_language']) ? $_POST['programming_language'] : $course['programming_language']) === 'Swift') ? 'selected' : ''; ?>>Swift</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="difficulty_level" name="difficulty_level" required>
                            ...
                            <option value="beginner" <?= ((isset($_POST['difficulty_level']) ? $_POST['difficulty_level'] : $course['difficulty_level']) === 'beginner') ? 'selected' : ''; ?>>Beginner</option>
                            <option value="intermediate" <?= ((isset($_POST['difficulty_level']) ? $_POST['difficulty_level'] : $course['difficulty_level']) === 'intermediate') ? 'selected' : ''; ?>>Intermediate</option>
                            <option value="advanced" <?= ((isset($_POST['difficulty_level']) ? $_POST['difficulty_level'] : $course['difficulty_level']) === 'advanced') ? 'selected' : ''; ?>>Advanced</option>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" id="thumbnail_url" name="thumbnail_url" 
                               value="<?= isset($_POST['thumbnail_url']) ? htmlspecialchars($_POST['thumbnail_url']) : htmlspecialchars($course['thumbnail_url'] ?? ''); ?>"
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea id="description" name="description" required rows="5"
                                  placeholder="Describe what students will learn in this course, including key topics, prerequisites, and learning outcomes..."><?= isset($_POST['description']) ? htmlspecialchars($_POST['description']) : htmlspecialchars($course['description']); ?></textarea>
